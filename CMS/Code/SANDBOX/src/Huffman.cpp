...
* Adapted By:  Rita Yevtushenko
*    Changes:     Enclosed functions in class
...
void Huff::_Huffman_InitBitstream(huff_bitstream_t * stream, unsigned char* buf)
{
    stream->BytePtr = buf;
    stream->BitPos = 0;
}
...
*************************************************************************/
 ...
 void Huff::_Huffman_Hist(unsigned char* in, huff_sym_t* sym,
    unsigned int size)
{
    int k;
...
void Huff::_Huffman_StoreTree(huff_encodenode_t* node, huff_sym_t* sym,
...
//// Define static Huff class instance
//static Huff huffInstance;
//
//// Wrapper for Huffman_Compress
//int Huffman_Compress_C(unsigned char* in, unsigned char* out, unsigned int insize) {
//    return huffInstance.Huffman_Compress(in, out, insize);
//}

int Huff::Huffman_Compress(unsigned char* in, unsigned char* out, unsigned int insize)
{
